...
export const SponsorsCarousel: React.FC = () => (
	<div className="w-full py-14">
		<div className="text-center font-heading text-ieee-bright-yellow text-3xl mb-12">
			OUR SPONSORS
		</div>
		<Carousel
				...
				{SPONSORS.map((sponsor, index) => (
					<CarouselItem key={index} className="pl-6 basis-full sm:basis-1/2 md:basis-1/3">
						<div className="flex flex-col items-center gap-4 group px-8 py-6">
							...
							<span className="text-base text-ieee-light-grey group-hover:text-ieee-bright-yellow font-body transition-colors text-center">
								{sponsor.name}
							</span>
							<span className="text-xs font-heading px-3 py-1 rounded-full border border-ieee-bright-yellow text-ieee-bright-yellow opacity-70 group-hover:opacity-100 transition-opacity tracking-widest uppercase">
								{sponsor.tier}
							</span>
						</div>
					</CarouselItem>
...
// ---------------------------------------------------------------------------
const PDF_PATH = '/sponsors/IEEE_UCF_Sponsorship_Packet_2026-2027.pdf';
...
export const PDFViewer: React.FC = () => {
	...
	if (isMobile) {
		return (
			<div className="flex flex-col items-center gap-6 rounded-xl border border-ieee-dark-grey/60 bg-ieee-near-black px-4 py-10">
				<svg
					className="w-14 h-14 text-ieee-bright-yellow"
					fill="none"
					stroke="currentColor"
					viewBox="0 0 24 24"
				>
				...
				<div className="text-center">
					<p className="text-white font-heading text-xl mb-1">
						IEEE UCF Sponsorship Package
					</p>
					<p className="text-ieee-light-grey font-body text-sm">
				...
				<div className="flex flex-row gap-4 w-full max-w-xs">
					...
					>
						<GlowButton>
							<span className="text-white font-heading text-sm">DOWNLOAD</span>
						</GlowButton>
					</a>
				</div>
			</div>
		...
		<>
			...
			<div className="my-10 flex flex-row flex-wrap items-center gap-x-5 lg:gap-x-10">
				...
				<a href={PDF_PATH} target="_blank" rel="noopener noreferrer">
					<GlowButton>
						<span className="text-white font-bold text-sm">OPEN IN NEW TAB</span>
					</GlowButton>
				</a>
			</div>
		</>
