...
export default function RegisterPage() {
	...
	return (
		<div className="flex justify-center min-h-screen items-center bg-ieee-black">
			<div className="relative w-full max-w-lg p-5 lg:m-10 rounded-lg border border-ieee-dark-grey bg-ieee-near-black shadow-lg sm:h-[90vh] justify-center">
						...
						<FieldGroup className="flex items-center justify-center place-content-center text-white h-1/2">
							<FieldSet>
								<div className="flex justify-center mb-4">
									<h1 className="text-4xl font-heading text-white">IEEE @ UCF</h1>
								</div>
								<div className="flex justify-center mb-6">
									<h2 className="text-white text-xl font-body-italic">
								...
								{!session?.user ? (
									<div className="flex flex-col justify-center items-center">
										<div className="relative group cursor-pointer ">
											<div className="absolute -inset-1 bg-gradient-to-r from-ieee-bright-yellow to-ieee-bright-yellow blur-md opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 rounded-md"></div>

											<Button
												variant="outline"
												type="button"
												onClick={handleDiscordSignIn}
												className="relative z-10 flex items-center justify-center gap-2 px-14 py-10 font-heading rounded-md text-black bg-ieee-dark-yellow hover:bg-ieee-bright-yellow border-none hover:scale-105 transition-all hover:cursor-pointer "
											>
												<svg
													className="w-5 h-5"
													fill="currentColor"
									...
									<>
										<div className="mb-6 flex items-center rounded-md border border-ieee-dark-yellow/40 bg-ieee-dark-yellow/10 p-4">
											{session.user.image && (
												<img
										...
										<div className="flex gap-4 mt-6">
											<Button
												type="submit"
												className="flex-1 hover:scale-102"
