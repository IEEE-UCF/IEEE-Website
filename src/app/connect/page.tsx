	...
	return (
		<div className="flex flex-col max-w-screen overflow-hidden">
			...
			<div className="flex display flex-col">
				{/* SOCIALS SECTION */}
				<div className="justify-between items-center py-20 px-8 lg:px-15 bg-ieee-warm-dark flex flex-col lg:flex-row gap-y-10 -translate-y-20">
					<div className="flex flex-col display gap-y-3 w-full lg:w-auto">
						<div className="text-ieee-bright-yellow font-heading text-4xl">
							FOLLOW OUR SOCIALS
						</div>
						<div className="flex flex-col lg:flex-row font-bold text-white text-xl lg:text-2xl items-center gap-x-5 font-body flex-wrap">
							ieee.ucf@gmail.com | ieee@ucf.edu
						</div>

						<Link
							href={'https://discord.com/invite/WBcKem9kCq'}
							className="flex flex-row font-bold text-white text-base lg:text-2xl items-center gap-x-5 font-body hover:text-ieee-bright-yellow transition-colors"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="35"
				...
				<div className="bg-black p-15 -translate-y-40">
					<div className="text-ieee-bright-yellow font-heading text-4xl place-self-start py-8">
						INTERESTED IN JOINING?
					</div>

					<div className="flex flex-row display justify-between flex-wrap basis-1">
						<Card className="lg:w-1/4 2xl:h-fit lg:h-100 w-full h-fit rounded-sm border border-ieee-grey bg-ieee-dark-grey opacity-90 transition-transform hover:scale-102 hover:opacity-100">
							<CardContent className="flex w-full justify-start flex-col items-start text-left gap-y-1 flex-wrap">
								<div className="font-heading text-white text-2xl">STEP ONE</div>
						...
						<Card className="lg:w-1/4 2xl:h-fit lg:h-100 w-full h-fit rounded-sm border border-ieee-grey bg-ieee-dark-grey opacity-90 transition-transform hover:scale-102 hover:opacity-100">
							<CardContent className="flex w-full justify-start flex-col items-start text-left gap-y-1 flex-wrap">
								<div className="font-heading text-white text-2xl">STEP TWO</div>
								<div className="font-body text-white">
						...
						<Card className="lg:w-1/4 2xl:h-fit lg:h-100 w-full h-fit rounded-sm border border-ieee-grey bg-ieee-dark-grey opacity-90 transition-transform hover:scale-102 hover:opacity-100">
							<CardContent className="flex w-full justify-start flex-col items-start text-left gap-y-1 flex-wrap">
								<div className="font-heading text-white text-2xl">STEP THREE</div>
								<div className="font-body text-white">
						...
						<Card className="lg:w-1/4 2xl:h-fit lg:h-100 w-full h-fit rounded-sm border border-ieee-grey bg-ieee-dark-grey opacity-90 transition-transform hover:scale-102 hover:opacity-100">
							<CardContent className="flex w-full justify-start flex-col items-start text-left gap-y-1 flex-wrap">
								<div className="font-heading text-white text-2xl">STEP FOUR</div>
								<div className="font-body text-white">
